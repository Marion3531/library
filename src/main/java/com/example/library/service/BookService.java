...
public class BookService {
	...
	public List<Book> searchBookByName(String query) {
        ...
        // This is exactly the same with the below.
//        return books.stream()
//                .filter(book -> {
//                    return (
...
//                            .stream()
//                            .anyMatch(author -> {
//                                return author.getFirstname().equalsIgnoreCase(query) || author.getLastname().equalsIgnoreCase(query)
//                            })
//                    );
//                })
//                .toList();

        // This is exactly the same with the above.
        // Inside a stream function (lambda) after the -> symbol, if you only have one command,
        // you can omit the curly brackets {} and the return statement and just put immediately the command.
        return books.stream()
                .filter(book ->
